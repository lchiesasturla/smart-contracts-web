        ...
        return (
            <Fragment>
                ...
                <Grid container spacing={1}>
                    ...
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Tipo de documento" variant="outlined" />
                    </Grid>
                    <Grid item xs={4}>
                ...
                <Grid container spacing={1}>
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Calle" variant="outlined" />
                    </Grid>
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Numero" variant="outlined" />
                    </Grid>
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Piso" variant="outlined" />
                    </Grid>
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Departamento" variant="outlined" />
                    </Grid>
                    <Grid item xs={4}>
                        <TextField className={classes.input} label="Entre calles" variant="outlined" />
                    </Grid>
                    <Grid item xs={2}>
                        <TextField className={classes.input} label="Codigo postal" variant="outlined" />
                    </Grid>
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Ciudad" variant="outlined" />
                    </Grid>
                    <Grid item xs={3}>
                        <TextField className={classes.input} label="Localidad" variant="outlined" />
                    </Grid>
                </Grid>
            </Fragment>
        );
